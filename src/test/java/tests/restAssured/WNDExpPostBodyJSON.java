...
public class WNDExpPostBodyJSON {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		HashMap<String, Object> master = new HashMap<String, Object>();
		HashMap<String, String> events = new HashMap<String, String>();	
		events.put("opportunityId", "2033143");
		events.put("event", "completed");
		master.put("RqUID", "1");
		master.put("events", events);
		...
		System.out.println("Master body is " + master);

// Source - https://www.educba.com/selection-sort-in-java/
// Source - https://www.educba.com/sorting-algorithms-in-java/?source=leftnav
...
public class SelectionSortExample {
	...
	public static void selsort(int[] arr) {
		...
		for (int i = 0; i < n - 1; i++) {
			...
			// Find the smallest element by comparing with the element in MIN
			// position
			for (int j = i + 1; j < n; j++) {
